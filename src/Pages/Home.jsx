...
function Home() {
  return (
    <>
      <main className="bg-neutral text-primary p-10 flex flex-col justify-start items-center">
        <section className="max-w-[80%] flex justify-center items-center text-left gap-10 mx-auto">
          {/* Left Section */}
