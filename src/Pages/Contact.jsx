...
function Contact() {
  ...
  const validateForm = () => {
    if (!formData.name.trim() || !formData.email.trim() || !formData.message.trim()) {
      toast.error(t("contact.errors.allFields"));
      return false;
    }
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    toast.loading(t("contact.errors.sending"), { id: "sending" });
    ...
    try {
      ...
      if (response.status === "success") {
        ...
        toast.error(t("contact.errors.failure"));
      }
    } catch (error) {
        ...
        <form className="flex flex-col justify-center items-center gap-6 w-[720px]" onSubmit={handleSubmit}>
          ...
          <label className="w-full">
            <div className="flex gap-2 items-center pb-4">
              ...
              <span className="text-xl font-tomorrow font-semibold">
                {t("contact.nameLabel")}
              </span>
            </div>
          ...
          <label className="w-full">
            <div className="flex gap-2 items-center pb-4">
              ...
              <span className="text-lg font-tomorrow font-semibold">
